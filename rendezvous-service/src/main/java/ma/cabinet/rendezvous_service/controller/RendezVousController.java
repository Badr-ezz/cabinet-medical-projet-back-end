...
public class RendezVousController {
         ...
         */
        @Operation(summary = "Create a new appointment", description = "Creates a new medical appointment. Requires SECRETARY or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Appointment created successfully", content = @Content(schema = @Schema(implementation = RendezVousResponse.class))),
         ...
         */
        @Operation(summary = "Get all appointments", description = "Retrieves all medical appointments. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
         ...
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Get appointment by ID", description = "Retrieves a specific appointment by its ID. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Appointment found", content = @Content(schema = @Schema(implementation = RendezVousResponse.class))),
         ...
         * Autorisé: SECRETARY, ADMIN
         */
        @Operation(summary = "Update an appointment", description = "Updates an existing appointment. Requires SECRETARY or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Appointment updated successfully", content = @Content(schema = @Schema(implementation = RendezVousResponse.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid request data"),
                        @ApiResponse(responseCode = "404", description = "Appointment not found"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions")
         ...
         */
        @Operation(summary = "Delete an appointment", description = "Deletes an appointment. Requires ADMIN role only.")
        @ApiResponses(value = {
         ...
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Get appointments by date", description = "Retrieves all appointments for a specific date. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "List of appointments retrieved successfully"),
        ...
        public ResponseEntity<List<RendezVousResponse>> getByDate(
                        @Parameter(description = "Date in ISO format (YYYY-MM-DD)", required = true, example = "2024-01-15") @RequestParam("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
         ...
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Get appointments by doctor and date", description = "Retrieves all appointments for a specific doctor on a specific date. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "List of appointments retrieved successfully"),
                        @ApiResponse(responseCode = "400", description = "Invalid date format"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
         ...
         * Autorisé: SECRETARY, ADMIN
         */
        @Operation(summary = "Confirm an appointment", description = "Confirms an appointment. Changes status to CONFIRME. Requires SECRETARY or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Appointment confirmed successfully", content = @Content(schema = @Schema(implementation = RendezVousResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Appointment not found"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions")
        })
         ...
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Cancel an appointment", description = "Cancels an appointment. Changes status to ANNULE. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Appointment cancelled successfully", content = @Content(schema = @Schema(implementation = RendezVousResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Appointment not found"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions")
        })
         ...
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Get appointments by patient", description = "Retrieves all appointments for a specific patient. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "List of appointments retrieved successfully"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions")
         ...
         * Autorisé: SECRETARY, ADMIN
         */
        @Operation(summary = "Get all appointments by cabinet", description = "Retrieves all appointments for a specific cabinet. Requires SECRETARY or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "List of appointments retrieved successfully"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions")
        ...
        /**
         * GET BY CABINET, MEDECIN AND DATE - Rendez-vous d'un médecin dans un cabinet à
         * une date
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Get appointments by cabinet, doctor and date", description = "Retrieves all appointments for a specific doctor in a specific cabinet on a specific date. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "List of appointments retrieved successfully"),
                        @ApiResponse(responseCode = "400", description = "Invalid date format"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized"),
        ...
        public ResponseEntity<List<RendezVousResponse>> getByCabinetMedecinDate(
                        ...
                        @Parameter(description = "Date in ISO format (YYYY-MM-DD)", required = true, example = "2024-01-15") @RequestParam("date") String dateStr) {
        ...
        /**
         * GET HISTORIQUE PATIENT - Historique des rendez-vous d'un patient dans un
         * cabinet
         * Autorisé: MEDECIN, SECRETARY, ADMIN
         */
        @Operation(summary = "Get patient appointment history", description = "Retrieves the complete appointment history for a patient in a specific cabinet. Requires MEDECIN, SECRETARY, or ADMIN role.")
        @ApiResponses(value = {
